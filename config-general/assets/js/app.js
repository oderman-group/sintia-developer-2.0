...
var App = function() {
    ...
    var handleQuickSidebarChat = function() {
        ...
        var handleChatMessagePost = function(e) {
            ...
            // handle post
            var time = new Date();
            var message = preparePost('out', (time.getHours() + ':' + time.getMinutes()), "Tú", 'dp', text);
            message = $(message);
            ...
            setTimeout(function() {
				...
				var texto = 'Dame un momento por favor.';
				if(text == 'hola'){var texto = 'Hola, cómo estás hoy?';}
				if(text == 'buenos dias' || text == 'buenos días'){var texto = 'Buenos días, cómo estás hoy?';}
				if(text == 'buenas tardes'){var texto = 'Buenas tardes, cómo estás hoy?';}
				if(text == 'bien'){var texto = 'Me alegra! Cómo te ayudo?';}
				if(text == 'mal'){var texto = 'Umm, y por qué? La vida es maravillosa a pesar de muchas cosas.';}
				if(text == 'gracias' || text == 'muchas gracias'){var texto = 'Es con mucho gusto!';}
				if(text == 'pringao' || text == 'eres un pringao'){var texto = 'Mira! Más pringao eres tú. Vete a tomar por culo.';}
				
                var time = new Date();
                var message = preparePost('in', (time.getHours() + ':' + time.getMinutes()), "Soporte SINTIA", 'prof/prof3', texto);
                message = $(message);
                chatContainer.append(message);
            }, 2000);
        };*/
