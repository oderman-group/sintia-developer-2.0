	...
	<body style="background-color:#FFF;">
		...
		<div style="width: 100%; display: grid; place-content: center;">
			...
			<div style="font-family:arial; background:#FAFAFA; width:600px; color:#000; text-align:justify; padding:15px;">
				...
				Número de solicitud:               <b><?=$data['solicitud_id'];?></b><br>
				Número de documento del aspirante: <b><?=$data['solicitud_documento'];?></b><br><br>

				Puede consultar el estado de su solicitud en el siguiente enlace:<br>
				<a href="<?=REDIRECT_ROUTE;?>/admisiones/consultar-estado.php?idInst=<?=$_REQUEST['idInst']?>&solicitud=<?=base64_encode($data['solicitud_id']);?>&documento=<?=base64_encode($data['solicitud_documento']);?>">CONSULTAR ESTADO DE SOLICITUD</a>
