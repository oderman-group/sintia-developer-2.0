...
VALUES('".$_SESSION['id']."', '".$_SERVER['PHP_SELF']."?".$_SERVER['QUERY_STRING']."', '".$idPaginaInterna."', '".$paisIP."', '".$ip."', '".$_SERVER['HTTP_USER_AGENT']."', '".$config['conf_id_institucion']."', '".$_SERVER["HTTP_REFERER"]."', '".$tiempoMostrar."', '".$idLogin."')");