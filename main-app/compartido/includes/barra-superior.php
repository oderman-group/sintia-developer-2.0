...
class componenteFiltro
{
    ...
    private $url;
    /**
     * @var int metodo por el cual se enviara el resultado obtenido del fetch.
     */
    private $metodo;
     /**
    ...
    public function __construct($id, $url, $metodo, $opciones = array(), $filtros = array() ,$filtros_get='')
    {
        ...
        $this->id = $id;
        $this->url = $protocolo . $_SERVER['HTTP_HOST'] . '/app-sintia/main-app/compartido/includes/filter/' . $url;
        $this->metodo = $metodo;
