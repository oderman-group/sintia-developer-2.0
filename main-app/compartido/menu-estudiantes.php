<?php 
							...
							<?php if (array_key_exists(Modulos::MODULO_ACADEMICO, $arregloModulos)) { ?>
							...
							<li class="nav-item">
	                            ...
	                            <ul class="sub-menu">
									...
									<?php if(!empty($arregloModulos) && array_key_exists(Modulos::MODULO_CLASES, $arregloModulos)){?>
										<li class="nav-item"><a href="ausencias.php" class="nav-link "> <span class="title"><?=$frases[7][$datosUsuarioActual['uss_idioma']];?></span></a></li>
									<?php }?>
									
									<?php if(!empty($arregloModulos) && array_key_exists(Modulos::MODULO_CRONOGRAMA, $arregloModulos)){?>
									...
									<?php if(!empty($arregloModulos) && array_key_exists(Modulos::MODULO_ACTIVIDAES, $arregloModulos)){?>
									...
									<?php if(!empty($arregloModulos) && array_key_exists(Modulos::MODULO_FOROS, $arregloModulos)){?>
										<li class="nav-item"><a href="foros.php" class="nav-link "> <span class="title"><?=$frases[113][$datosUsuarioActual['uss_idioma']];?></span></a></li>
									<?php }?>
									
									<?php if(!empty($arregloModulos) && array_key_exists(Modulos::MODULO_EVALUACIONES, $arregloModulos)){?>
							...
							<?php if (array_key_exists(Modulos::MODULO_CARPETAS, $arregloModulos)) { ?>
								<li class="nav-item">
							...
							<?php if (array_key_exists(Modulos::MODULO_GENERAL, $arregloModulos)) { ?>
								<li class="nav-item">
							...
							<?php if (array_key_exists(Modulos::MODULO_FINANCIERO, $arregloModulos)) { ?>
								<li class="nav-item">
							...
							<?php if (array_key_exists(Modulos::MODULO_DISCIPLINARIO, $arregloModulos)) { ?>
								<li class="nav-item">
							...
							<?php if(array_key_exists(Modulos::MODULO_DISCIPLINARIO, $arregloModulos) && $config['conf_ver_observador']==1){?>
								<li class="nav-item">
