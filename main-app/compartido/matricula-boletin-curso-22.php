		...
		<table width="100%" id="tblBoletin" cellspacing="0" cellpadding="0" rules="all" border="1" align="left">
				...
				<?php foreach ($area["cargas"] as $carga) { ?>
					<tr bgcolor="#EAEAEA" style="font-size:12px;">
						...
						<?php for ($k = 1; $k <= $periodoActual; $k++) {
							...
							<td class="" align="center" style="font-weight:bold; background:#EAEAEA; font-size:16px;">
								<?= Boletin::formatoNota($carga["periodos"][$k]['bol_nota'], $tiposNotas); ?></br>
								<?php
						...
						<?php } ?>
						<td align="center" style="font-weight:bold; background:#EAEAEA;"><?=Boletin::formatoNota($carga["carga_acumulada"], $tiposNotas)?></td>
						<td align="center" style="font-weight:bold; background:#EAEAEA;"><?=Boletin::determinarRango($carga["carga_acumulada"], $tiposNotas)["notip_nombre"]?></td>
					...
					<?php foreach ($carga["periodos"][$periodoActual]["indicadores"] as $indicador) { 
						...
						<?php for ($k = 1; $k <= $periodoActual-1; $k++) {?>
							<td align="center" style="font-weight:bold; font-size:12px;"></td>
						<?php } ?>
						<td align="center" style="font-size:12px; height:15px;<?= $recuperoIndicador ? 'color: #2b34f4;" title="Nota indicador recuperada ' . $indicador['valor_indicador'] . '"' : '' ?>"" <?= $indicador['ind_nombre']; ?>"><?php echo $indicador["nota_final"];?></td> 
						<td align="center" style="font-weight:bold;"></td>
						<td align="center" style="font-weight:bold;"></td>
						<td align="center" style="font-weight:bold;"></td>
						</tr>
			...
			<table width="100%" cellspacing="0" cellpadding="0" rules="none" border="0"
				...
				<tr>
					...
					<td align="center">_________________________________<br><!--<?= strtoupper(""); ?><br>-->Director(a) de
						grupo</td>
				</tr>
			</table>
