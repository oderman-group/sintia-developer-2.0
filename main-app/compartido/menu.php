	                    ...
	                    <ul class="sidemenu  page-header-fixed <?=$datosUsuarioActual['uss_tipo_menu'];?>" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px" data-step="1" data-intro="<b>Menú principal:</b> Aquí encontrarás todas las opciones para el uso de la plataforma." data-position='left'>
							...
							?>
								...
								<li class="nav-item">
									...
									<ul  class="sub-menu">
										<li class="nav-item"><a href="#" class="nav-link"> <span class="title">Categorias productos</span></a></li>
										<li class="nav-item"><a href="#" class="nav-link"> <span class="title">Categorias servicios</span></a></li>
										<li class="nav-item"><a href="#" class="nav-link"> <span class="title">Productos</span></a></li>
										<li class="nav-item"><a href="#" class="nav-link"> <span class="title">Empresas</span></a></li>
									</ul>
								</li>
							<?php }?>
