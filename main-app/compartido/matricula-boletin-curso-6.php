...
for($l=1;$l<=$numero_periodos;$l++){
	$consultaNotaEstudiante=mysqli_query($conexion, "SELECT * FROM ".BD_ACADEMICA.".academico_boletin WHERE bol_carga='".$fila2['car_id']."' AND bol_estudiante='".$matriculadosDatos[0]."' AND bol_periodo='".$l."' AND institucion={$config['conf_id_institucion']} AND year={$year}");
