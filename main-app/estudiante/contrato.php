                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title"><?=$frases[333][$datosUsuarioActual['uss_idioma']];?></div>
                    ...
                    <div class="row">
						...
						<div class="col-sm-9">
						    <div class="card card-box">
						        <div class="card-head">
						            <header><?=$frases[333][$datosUsuarioActual['uss_idioma']];?></header>
						        </div>
						        <div class="card-body " id="bar-parent6">

<h2 style="text-align: justify;"><?=$frases[351][$datosUsuarioActual['uss_idioma']];?></h2>
<p style="text-align: justify;"><strong>&nbsp;</strong></p>
<p style="text-align: justify;"><strong>&nbsp;</strong></p>
<p style="text-align: justify;"><strong><?=strtoupper($frases[61][$datosUsuarioActual['uss_idioma']]);?>: <?= $datosEstudianteActual["mat_primer_apellido"]." ".$datosEstudianteActual["mat_segundo_apellido"]." ".$datosEstudianteActual["mat_nombres"]; ?></strong></p>
<p style="text-align: justify;">&nbsp;</p>
<p style="text-align: justify;"><strong><?=strtoupper($frases[26][$datosUsuarioActual['uss_idioma']]);?>: <?= $datosEstudianteActual["gra_nombre"]; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </strong></p>
<p style="text-align: justify;">&nbsp;</p>
...
<p style="text-align: justify;">Para constancia se firma en Medell&iacute;n por quienes intervinieron en este contrato a los <b><?= date("d");?></b> d&iacute;as del mes de <b><?= date("M");?></b> del a&ntilde;o <b><?= date("Y");?></b>.</p>
						            ...
						            <form action="../compartido/contrato-aceptar.php" method="post" enctype="multipart/form-data">
