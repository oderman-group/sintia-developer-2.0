                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title"><?=$frases[333][$datosUsuarioActual[8]];?></div>
                    ...
                    <div class="row">
						...
						<div class="col-sm-9">
						    <div class="card card-box">
						        <div class="card-head">
						            <header><?=$frases[333][$datosUsuarioActual[8]];?></header>
						        </div>
						        <div class="card-body " id="bar-parent6">

<h2 style="text-align: justify;"><?=$frases[351][$datosUsuarioActual[8]];?></h2>
<p style="text-align: justify;"><strong>&nbsp;</strong></p>
<p style="text-align: justify;"><strong>&nbsp;</strong></p>
<p style="text-align: justify;"><strong><?=strtoupper($frases[61][$datosUsuarioActual[8]]);?>: <?= $datosEstudianteActual["mat_primer_apellido"]." ".$datosEstudianteActual["mat_segundo_apellido"]." ".$datosEstudianteActual["mat_nombres"]; ?></strong></p>
<p style="text-align: justify;">&nbsp;</p>
<p style="text-align: justify;"><strong><?=strtoupper($frases[26][$datosUsuarioActual[8]]);?>: <?= $datosEstudianteActual["gra_nombre"]; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </strong></p>
<p style="text-align: justify;">&nbsp;</p>
