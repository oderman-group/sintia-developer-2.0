                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title"><?=$frases[338][$datosUsuarioActual['uss_idioma']];?></div>
                    ...
                    <div class="row">
						...
						<div class="col-sm-9">
						    <div class="card card-box">
						        <div class="card-head">
						            <header><?=$frases[338][$datosUsuarioActual['uss_idioma']];?></header>
						        </div>
...
<p style="text-align: justify;">&nbsp;</p>
						            ...
						            <form action="../compartido/aceptar-contrato14.php" method="post" enctype="multipart/form-data">
