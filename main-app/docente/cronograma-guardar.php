...
try{
	mysqli_query($conexion, "INSERT INTO ".BD_ACADEMICA.".academico_cronograma(cro_tema, cro_fecha, cro_id_carga, cro_recursos, cro_periodo, cro_color, institucion, year)"." VALUES('".mysqli_real_escape_string($conexion,$_POST["contenido"])."', '".$date."', '".$cargaConsultaActual."', '".$_POST["recursos"]."', '".$periodoConsultaActual."', '".$_POST["colorFondo"]."', {$config['conf_id_institucion']}, {$_SESSION["bd"]})");
} catch (Exception $e) {
