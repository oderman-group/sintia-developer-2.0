...
$idPaginaInterna = 'DC0105';
include(ROOT_PATH."/main-app/compartido/historial-acciones-guardar.php");

$datosMensaje = AjaxCalificaciones::ajaxGuardarObservacionDisciplina($conexion,$_POST["codEst"],$_POST["carga"],$_POST["observacion"],$_POST["periodo"]);
