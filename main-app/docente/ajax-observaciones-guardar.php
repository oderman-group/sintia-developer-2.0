...
$idPaginaInterna = 'DC0101';
include(ROOT_PATH."/main-app/compartido/historial-acciones-guardar.php");

$datosMensaje = AjaxCalificaciones::ajaxGuardarObservacion($conexion,$_POST["codEst"],$_POST["nombreEst"],$_POST["codObservacion"],$_POST["observacion"]);
