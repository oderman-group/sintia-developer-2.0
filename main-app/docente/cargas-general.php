											...
											<table class="table table-striped custom-table table-hover">
                                                ...
                                                <tbody>
													...
													<tr>
                                        				...
                                        				<td align="center"><a href="cronograma.php?carga=<?=base64_encode($resultado['car_id']);?>&periodo=<?=base64_encode($resultado['car_periodo']);?>&get=<?=base64_encode(100);?>" style="text-decoration: underline;"><?=$numerosCargas[4];?></a></td>
