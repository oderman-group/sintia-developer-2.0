                        ...
                        <div class="col-md-12">
                            <div class="row">
								...
								<div class="col-md-4 col-lg-3">
									...
									<div class="panel">
										...
										<div class="panel-body">
											...
											WHERE form_id!='".$_GET["idF"]."' AND institucion={$config['conf_id_institucion']} AND year={$_SESSION["bd"]}
								...
								<div class="col-md-8 col-lg-9">
									...
									<form name="formularioGuardar" action="#" method="post">
                                            ...
                                            <table class="table table-striped custom-table table-hover">
                                                ...
                                                <tbody>
													...
													<tr style="color: <?=$colorDefault ;?>;">
														...
														<td><input type="text" style="text-align: center;" size="5" maxlength="3" value="<?=$notas['res_id_respuesta'];?>" name="P<?=$contReg;?>" autocomplete="off" disabled></td>
                                                    </tr>
													<?php 
														 $contReg++;
													  }
												...
												<a href="monitoreos.php" class="btn btn-secondary"><i class="fa fa-long-arrow-left"></i>Regresar</a>
										</form>
                                </div>
