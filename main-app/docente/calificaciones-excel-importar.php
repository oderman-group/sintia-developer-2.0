...
$calificacion = Actividades::consultarDatosActividades($config, $_GET["idR"]);
?>
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title"><?=$frases[31][$datosUsuarioActual['uss_idioma']];?></div>
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active"><?=$frases[31][$datosUsuarioActual['uss_idioma']];?></li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
						...
						<div class="col-sm-3">
							...
							<div class="panel">
								...
								<div class="panel-body">
										<?php
										$enComun = Actividades::consultaActividadesDiferentesCarga($config, $_GET["idR"], $cargaConsultaActual, $periodoConsultaActual);
