...
$idPaginaInterna = 'DC0108';
include(ROOT_PATH."/main-app/compartido/historial-acciones-guardar.php");

$datosMensaje = AjaxCalificaciones::ajaxGuardarRecuperacionIndicadores($conexion,$config,$_POST["codEst"],$_POST["carga"],$_POST["periodo"],$_POST["codNota"],$_POST["nota"],$_POST["notaAnterior"]);
