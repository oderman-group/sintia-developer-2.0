...
if ($newId > 0) {
    ...
    //Estudiante
    $estuQuery = "INSERT INTO usuarios(uss_usuario, uss_clave, uss_tipo, uss_nombre, uss_estado, uss_permiso1, uss_foto, uss_portada, uss_idioma, uss_tema, uss_tipo_documento, uss_apellido1)VALUES(:ussDocumento, '12345678', 4, :ussNombres, 0, 0, 'default.png', 'default.png', 1, 'green', :ussTipoDocumento, :ussApellido1)";
    ...
    //Acudiente
    $acudienteQuery = "INSERT INTO usuarios(uss_usuario, uss_clave, uss_tipo, uss_nombre, uss_email, uss_celular)VALUES(:usuario, '12345678', 3, :nombre, :email, :celular)";
