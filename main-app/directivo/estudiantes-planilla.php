                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Planilla de estudiantes</div>
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Planilla de estudiantes</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="panel">
                                ...
                                <form name="formularioGuardar" action="../compartido/planilla-estudiantes.php" method="post" target="_blank">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <?php
                                            try{
                                                $opcionesConsulta = mysqli_query($conexion, "SELECT * FROM ".BD_ACADEMICA.".academico_grados AND institucion={$config['conf_id_institucion']} AND year={$_SESSION["bd"]} ORDER BY gra_vocal");
                                            } catch (Exception $e) {
