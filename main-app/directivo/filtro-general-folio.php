            ...
            <div class="page-content">
                <div class="page-bar">
                    <div class="page-title-breadcrumb">
                        <div class=" pull-left">
                            <div class="page-title">Generar Folios</div>
                    ...
                    <div class="col-sm-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <form name="formularioGuardar" action="generar-folio-guardar.php" method="post">

                                    <div class="form-group row">
                                        <label class="col-sm-2 control-label">Número de inicio de folio</label>
                                        <div class="col-sm-8">
                                            <input type="number" name="numFolio" class="form-control col-sm-2" required>
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label class="col-sm-2 control-label">Estudiantes a generar folio</label>
                                        <div class="col-sm-4">
                                            <select class="form-control  select2" name="tipoEstudiantes">
