                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Planilla Docentes con Notas</div>
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Planilla Docentes con Notas</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="panel">
                                ...
                                <form name="formularioGuardar" action="../compartido/planilla-docentes-notas.php" method="post" target="_blank">
