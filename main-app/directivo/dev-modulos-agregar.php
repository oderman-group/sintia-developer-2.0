                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Agregar Modulos</div>
								<?php include("../compartido/texto-manual-ayuda.php");?>
                            </div>
							<ol class="breadcrumb page-breadcrumb pull-right">
                                <li><a class="parent-item" href="javascript:void(0);" name="dev-modulos.php" onClick="deseaRegresar(this)"><?=$frases[402][$datosUsuarioActual['uss_idioma']];?></a>&nbsp;<i class="fa fa-angle-right"></i></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
								...
								<div class="panel">
									...
									<form name="formularioGuardar" action="dev-modulos-guardar.php" method="post" enctype="multipart/form-data">
										
                                        <div class="form-group row">
                                            <label class="col-sm-2 control-label">Modulo<span style="color: red;">(*)</span></label>
                                            <div class="col-sm-8">
                                                <input type="text" name="nombreModulo" class="form-control" required>
                                            </div>
                                        </div>
