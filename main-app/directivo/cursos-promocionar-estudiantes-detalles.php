                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <p <?php if (empty($_POST['escogioCursos']) && empty($_POST['relacionoMaterias'])) { echo 'style="background-color: #ff572238;"'; } ?>>
                                    <b>1.</b> Debe escoger el curso desde donde desea promover los estudiantes, seguido de esto debe escoger el curso al que desea mover los estudiantes y dele click al botón continuar.
                                </p>
                                <p <?php if (!empty($_POST['escogioCursos'])) { echo 'style="background-color: #ff572238;"'; } ?>>
                                    <b>2.</b> Relacione las asignaturas del curso a promover con las asignaturas del curso al que se van a mover los estudiantes <mark>tenga muy en cuenta grupo y asignatura</mark> y dele click al botón continuar.
                                </p>
                                <p <?php if (!empty($_POST['relacionoMaterias'])) { echo 'style="background-color: #ff572238;"'; } ?>>
                        ...
                        <div class="panel">
                                ...
                                <div class="panel-body">
                                    <p><b>-></b> Al relacionar las materias, verifique que coincidan <mark>el grupo y la asignatura</mark> que escoja.</p>
                                    <p><b>-></b> Si desea cambiar el grupo de un estudiante, escoja el nuevo grupo en el selector frente al estudiante en la columna "GRUPO".</p>
                                </div>
                        </div>
                    </div>
                    <div class="col-sm-9">
                            ...
                            <div class="panel-body">
                                ...
                                <?php 
                                    if(!empty($_POST['escogioCursos'])){ 
                                        ...
                                        $cursoPara='';
                                        if(!empty($_POST['para'])) {
                                            $cursoPara=$_POST["para"];
                                        }
                                        $filtroPara = " AND car_curso='".$cursoPara."'";
                                ?>
                                    <form action="cursos-promocionar-estudiantes-detalles.php" method="post" enctype="multipart/form-data">
                                                                    ...
                                                                    ?>
                                                                        <tr >
                                                                            ...
                                                                            <td>
                                                                                <div class="form-group row">
                                                                                    <div class="col-sm-10">
                                                                                        <select class="form-control  select2"  onchange="crearInputCarga(this)" id="carga<?=$datosCarga['car_id'];?>" data-carga="<?=$datosCarga['car_id'];?>" <?=$disabledPermiso;?> required>
                                                                                            <option value="">Seleccione una opción</option>
                                                                                            <?php
                                ...
                                <?php 
                                    ...
                                    if(!empty($_POST['relacionoMaterias'])){ 
                                        ...
                                        $filtro = " AND mat_grado='".$curso."' AND (mat_promocionado=0 OR mat_promocionado=NULL) AND mat_estado_matricula=1";
                                ...
                                ?>
                                    <form action="cursos-promocionar-estudiantes.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <?php
                                            $filtroCarga = " AND car_curso='".$curso."'";
