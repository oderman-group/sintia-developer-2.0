<?php
	...
	if($nueva!=1){//SI ES 0 LA INSTITUCION ES ANTIGUA Y SE EJECUTA EL SIGUIENTE SCRIPT
		...
		mysqli_query($conexion, "INSERT INTO ".$baseDatosServicios.".configuracion (conf_agno,conf_periodo,conf_nota_desde,conf_nota_hasta,conf_nota_minima_aprobar,conf_color_perdida,conf_color_ganada,conf_saldo_pendiente,conf_num_restaurar,conf_restaurar_cantidad,conf_color_borde,conf_color_encabezado,conf_tam_borde,conf_num_materias_perder_agno,conf_inicio_matrucula,conf_fin_matricula,conf_apertura_academica,conf_clausura_academica,conf_periodos_maximos,conf_num_indicadores,conf_valor_indicadores,conf_notas_categoria,conf_id_institucion,conf_base_datos,conf_servidor,conf_usuario,conf_agregar_porcentaje_asignaturas,conf_fecha_parcial,conf_descripcion_parcial,conf_ancho_imagen,conf_alto_imagen,conf_mostrar_nombre,conf_deuda,conf_valor,conf_concepto,conf_inicio_recibos_ingreso,conf_inicio_recibos_egreso,conf_decimales_notas,conf_activar_encuesta,conf_sin_nota_numerica,conf_numero_factura,conf_max_peso_archivos,conf_informe_parcial,conf_ver_observador,conf_ficha_estudiantil,conf_solicitar_acudiente_2,conf_mostrar_campos,conf_calificaciones_acudientes,conf_mostrar_calificaciones_estudiantes) VALUES ('".$year."',1,'".$datosConfAnterior['conf_nota_desde']."','".$datosConfAnterior['conf_nota_hasta']."','".$datosConfAnterior['conf_nota_minima_aprobar']."','#e10000','#0000d5','".$datosConfAnterior['conf_saldo_pendiente']."','".$datosConfAnterior['conf_num_restaurar']."','".$datosConfAnterior['conf_restaurar_cantidad']."','#000000','#ff0080',1,3,'".$fecha."','".$fecha."','".$fecha."','".$fecha."',4,'".$datosConfAnterior['conf_num_indicadores']."','".$datosConfAnterior['conf_valor_indicadores']."','".$datosConfAnterior['conf_notas_categoria']."','".$idInsti."','mobiliar_".$siglasBD."',NULL,NULL,,'".$datosConfAnterior['conf_agregar_porcentaje_asignaturas']."',NULL,NULL,'200','150',1,'".$datosConfAnterior['conf_deuda']."','".$datosConfAnterior['conf_valor']."',NULL,NULL,NULL,'".$datosConfAnterior['conf_decimales_notas']."','".$datosConfAnterior['conf_activar_encuesta']."','".$datosConfAnterior['conf_sin_nota_numerica']."','".$datosConfAnterior['conf_numero_factura']."','".$datosConfAnterior['conf_max_peso_archivos']."','".$datosConfAnterior['conf_informe_parcial']."','".$datosConfAnterior['conf_ver_observador']."','".$datosConfAnterior['conf_ficha_estudiantil']."','".$datosConfAnterior['conf_solicitar_acudiente_2']."','".$datosConfAnterior['conf_mostrar_campos']."','".$datosConfAnterior['conf_calificaciones_acudientes']."','".$datosConfAnterior['conf_mostrar_calificaciones_estudiantes']."')");
		...
		mysqli_query($conexion, "INSERT INTO ".$baseDatosServicios.".configuracion (conf_agno,conf_periodo,conf_nota_desde,conf_nota_hasta,conf_nota_minima_aprobar,conf_color_perdida,conf_color_ganada,conf_saldo_pendiente,conf_num_restaurar,conf_restaurar_cantidad,conf_color_borde,conf_color_encabezado,conf_tam_borde,conf_num_materias_perder_agno,conf_inicio_matrucula,conf_fin_matricula,conf_apertura_academica,conf_clausura_academica,conf_periodos_maximos,conf_num_indicadores,conf_valor_indicadores,conf_notas_categoria,conf_id_institucion,conf_base_datos,conf_servidor,conf_usuario,conf_agregar_porcentaje_asignaturas,conf_fecha_parcial,conf_descripcion_parcial,conf_ancho_imagen,conf_alto_imagen,conf_mostrar_nombre,conf_deuda,conf_valor,conf_concepto,conf_inicio_recibos_ingreso,conf_inicio_recibos_egreso,conf_decimales_notas,conf_activar_encuesta,conf_sin_nota_numerica,conf_numero_factura,conf_max_peso_archivos,conf_informe_parcial,conf_ver_observador,conf_ficha_estudiantil,conf_solicitar_acudiente_2,conf_mostrar_campos,conf_calificaciones_acudientes,conf_mostrar_calificaciones_estudiantes) VALUES ('".$year."',1,1,5,3,8,'#e10000','#0000d5',NULL,NULL,NULL,'#000000','#ff0080',1,3,'".$fecha."','".$fecha."','".$fecha."','".$fecha."',4,NULL,NULL,NULL,'".$idInsti."','mobiliar_".$siglasBD."',NULL,NULL,'NO',NULL,NULL,'200','150',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'5',0,0,0,'NO',1,0,1)");
