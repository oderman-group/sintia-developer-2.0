                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Consolidados</div>
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Consolidados</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="panel">
                                ...
                                <form name="formularioGuardar" action="../compartido/informe-consolidado-perdidos.php" method="post" target="_blank">
