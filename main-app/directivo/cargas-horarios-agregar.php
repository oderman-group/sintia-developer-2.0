                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Agregar Horarios</div>
                        ...
                        <div class="col-sm-12">
								...
								<div class="panel">
									...
									<form name="formularioGuardar" action="cargas-horarios-guardar.php" method="post">
                                      ...
                                      <?php $botones = new botonesGuardar("cargas-horarios.php?id=".$_GET["id"],Modulos::validarPermisoEdicion()); ?>
                                    </form>
                                </div>
                            </div>
                        </div>
