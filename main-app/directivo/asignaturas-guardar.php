...
<?php
    ...
    if(trim($_POST["codigoM"])=="" or trim($_POST["nombreM"])=="" or trim($_POST["siglasM"])=="" or trim($_POST["areaM"])==""){
        echo '<script type="text/javascript">window.location.href="asignaturas-agregar.php?msgAsignatura=2";</script>';
        exit();
    }
	...
	echo '<script type="text/javascript">window.location.href="asignaturas.php?msgAsignatura=1";</script>';
    exit();