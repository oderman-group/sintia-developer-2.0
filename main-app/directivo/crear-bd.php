...
$nueva=0; //VALORES: 1 SI ES NUEVA Y 0 SI ES ANTIGUA

//DATOS BASICOS DE LA INSTITUCIÓN
$idInsti=5;//LE MODIFICAMOS EL VALOR SOLO CUANDO LA INSTITUCION ES ANTIGUA
$siglasBD='eoa_lacamila';//AQUI COLOCAMOS LAS SIGLAS QUE VAN AL INTERMEDIO DEL NOMBRE DE LA BD EJE: monbiliar_{[$siglasBD]}_{[$year]}
