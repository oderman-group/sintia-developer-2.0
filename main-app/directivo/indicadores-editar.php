                    ...
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
                                <li><a class="parent-item" href="javascript:void(0);" name="indicadores.php" onClick="deseaRegresar(this)"><?=$frases[63][$datosUsuarioActual[8]];?></a>&nbsp;<i class="fa fa-angle-right"></i></li>
                        ...
                        <div class="col-sm-9">
								...
								<div class="panel">
									...
									<form name="formularioGuardar" action="guardar.php?carga=<?=$cargaConsultaActual;?>&periodo=<?=$periodoConsultaActual;?>" method="post">
										...
										<input type="hidden" value="<?=$indicador['ipc_valor'];?>" name="valorIndicador">
											...
											<?php }else{?>
												<div class="form-group row">
													...
													<div class="col-sm-2">
														<input type="text" class="form-control" value="<?=$indicador['ipc_valor'];?>" readonly>
													</div>
												</div>
											<?php }?>
										...
										<a href="javascript:void(0);" name="indicadores.php" class="btn btn-secondary" onClick="deseaRegresar(this)"><i class="fa fa-long-arrow-left"></i>Regresar</a>
                                    </form>
                                </div>
                            </div>
                        </div>
