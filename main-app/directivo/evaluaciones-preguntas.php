										...
										<input type="hidden" name="cantPreguntas" value="<?=$cantPreguntas;?>">
											...
											?>
												<p>	
													...
													<input style="border: thin; border-style: solid; border-color: <?=$colorRespuesta;?>;" size="60" id="<?=$respuestas['resp_id'];?>" value="<?=$respuestas['resp_descripcion'];?>" title="<?=$preguntas['preg_id'];?>" alt="1" onChange="guardarAjax(this)">													
												</p>
											<?php
													$contRespuestas ++;
												}
