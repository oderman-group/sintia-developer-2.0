            ...
            <div class="page-content">
                <div class="page-bar">
                    <div class="page-title-breadcrumb">
                        <div class=" pull-left">
                            <div class="page-title">Editar Categorias de Servicios</div>
                        ...
                        <ol class="breadcrumb page-breadcrumb pull-right">
                            ...
                            <li class="active">Editar Categorias de Servicios</li>
                        </ol>
                    </div>
                </div>
                            ...
                            <div class="panel-body">
                                ...
                                <form name="formularioGuardar" action="mps-categorias-servicios-actualizar.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="nombre" class="form-control" id="nombre" value="<?= $datosCategorias['svcat_nombre']; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="icon" class="form-control" id="icon" value="<?= $datosCategorias['svcat_icon']; ?>" required>
                                        </div>
                                    </div>
