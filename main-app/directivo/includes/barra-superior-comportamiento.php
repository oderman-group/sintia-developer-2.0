...
if (!empty($_GET['curso'])) {
  ...
  $grado = GradoServicios::consultarCurso($cursoGet);
  $opciones[0] = [
    ComponenteFiltro::COMPB_OPCIONES_TEXTO   => 'Curso Actual: '.$grado["gra_nombre"],
    ComponenteFiltro::COMPB_OPCIONES_URL     => NULL,
    ComponenteFiltro::COMPB_OPCIONES_PERMISO => NULL
  ];
}
...
$barraSuperior = new ComponenteFiltro('comportamiento', 'filter-comportamiento.php', 'comportamiento-tbody.php', $filtros, $opciones, "", false);
