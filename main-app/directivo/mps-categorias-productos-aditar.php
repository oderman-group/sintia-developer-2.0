<?php
include("session.php");
$idPaginaInterna = 'DV0046';
include("../compartido/historial-acciones-guardar.php");
Modulos::verificarPermisoDev();
include("../compartido/head.php");

try {
    $consulta = mysqli_query($conexion, "SELECT * FROM " . $baseDatosMarketPlace . ".categorias_productos WHERE catp_id='" . base64_decode($_GET["idR"]) . "'");
} catch (Exception $e) {
    include("../compartido/error-catch-to-report.php");
}
$datosCategorias = mysqli_fetch_array($consulta, MYSQLI_BOTH);
?>
            ...
            <div class="page-content">
                <div class="page-bar">
                    <div class="page-title-breadcrumb">
                        <div class=" pull-left">
                            <div class="page-title">Editar Categorias de Producto</div>
                            ...
                            <div class="panel-body">
                                ...
                                <form name="formularioGuardar" action="mps-categorias-productos-actualizar.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="nombre" class="form-control" id="nombre" value="<?= $datosCategorias['catp_nombre']; ?>" required>
                                        </div>
                                    </div>

                                    <?php $botones = new botonesGuardar("mps-categorias-productos.php",Modulos::validarPermisoEdicion()); ?>
                                </form>
                            </div>
                        </div>
                    </div>
