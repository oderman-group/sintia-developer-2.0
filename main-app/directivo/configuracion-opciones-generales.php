														...
														<td>
															<div class="btn-group">
																  ...
																  <ul class="dropdown-menu" role="menu">
																	  ...
																	  <li>
                                                                      <a href="#" title="Eliminar" data-toggle="popover" data-placement="top" data-content="Eliminar" title="Eliminar Horarios" onClick="sweetConfirmacion('Alerta!','Deseas eliminar este registro?','question','guardar.php?idogen=<?=$resultado["ogen_id"];?>&get=50')">Eliminar</a>  
                                                                     </li>
																  </ul>
															</div>
														</td>
