                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title"><?=$frases[56][$datosUsuarioActual['uss_idioma']];?> Items</div>
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active"><?=$frases[56][$datosUsuarioActual['uss_idioma']];?> Items</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="panel">
                                <header class="panel-heading panel-heading-purple"><?=$frases[56][$datosUsuarioActual['uss_idioma']];?> Items</header>
                                <div class="panel-body">
									<form name="formularioGuardar" action="items-guardar.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                <textarea cols="80" id="editor1" name="descrip" class="form-control" rows="8" placeholder="Escribe tu mensaje" style="margin-top: 0px; margin-bottom: 0px; height: 100px; resize: none;" <?=$disabledPermiso;?>></textarea>
                                            </div>
                                        </div>
