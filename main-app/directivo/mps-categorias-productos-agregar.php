            ...
            <div class="page-content">
                <div class="page-bar">
                    <div class="page-title-breadcrumb">
                        <div class=" pull-left">
                            <div class="page-title">Agregar Categorias de Producto</div>
                        ...
                        <ol class="breadcrumb page-breadcrumb pull-right">
                            ...
                            <li class="active">Agregar Categorias de Producto</li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <form name="formularioGuardar" action="mps-categorias-productos-guardar.php" method="post" enctype="multipart/form-data">
