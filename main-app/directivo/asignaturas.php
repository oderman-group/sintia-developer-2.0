															...
															<td>
																<div class="btn-group">
																	...
																	<ul class="dropdown-menu" role="menu">
																		...
																		<?php if($numeros[0]==0){?><li><a href="#" onClick="sweetConfirmacion('Alerta!','Deseas eliminar este registro?','question','asignaturas-eliminar.php?id=<?=base64_encode($resultado[0]);?>')">Eliminar</a></li><?php } ?>
																	</ul>
																</div>
															</td>
														<?php }?>
