								...
								<div class="panel">
										...
										<div class="panel-body">
												...
												<div class="form-group row">
													...
													<div class="col-sm-2">
														<input type="radio" name="opcionR" value="1" checked onClick="tipoPregunta(this)"> Selección Multiple
													</div>
													<div class="col-sm-2">
														<input type="radio" name="opcionR" value="2" onChange="tipoPregunta(this)"> Falso y verdadero
													</div>
												</div>
