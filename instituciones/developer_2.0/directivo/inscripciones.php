                                        ...
                                        <div class="table-scrollable">
                                    		<table id="example1" class="display" style="width:100%;">
                                                ...
                                                <tr id="data1" class="odd gradeX" style="color: ;">
                                                    ...
                                                    <td><a href="https://plataformasintia.com/instituciones/developer_2.0/admisiones/files/comprobantes/<?= $resultado["asp_comprobante"]; ?>" target="_blank" style="text-decoration: underline;"><?= $resultado["asp_comprobante"]; ?></a></td>
