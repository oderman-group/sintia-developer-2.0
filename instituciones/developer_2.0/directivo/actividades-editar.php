...
<?php $idPaginaInterna = 'DT0015';?>
<?php include("../compartido/historial-acciones-guardar.php");?>
<?php include("verificar-carga.php");?>
<?php include("verificar-periodos-diferentes.php");?>
<?php include("../compartido/head.php");?>
<?php
$datosConsulta = mysql_fetch_array(mysql_query("SELECT * FROM academico_actividad_tareas WHERE tar_id='".$_GET["idR"]."' AND tar_estado=1",$conexion));
?>
									...
									<form name="formularioGuardar" action="guardar.php?carga=<?=$cargaConsultaActual;?>&periodo=<?=$periodoConsultaActual;?>" method="post" enctype="multipart/form-data">
										...
										<input type="hidden" value="<?=$_GET["idR"];?>" name="idR">
											...
											<div class="form-group row">
												...
												<div class="col-sm-10">
													<input type="text" name="contenido" class="form-control" autocomplete="off" value="<?=$datosConsulta['tar_descripcion'];?>">
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-sm-4">
													<?php if($datosConsulta['tar_archivo']!=""){?><a href="../files/tareas/<?=$resultado['tar_archivo'];?>" target="_blank"><?=$datosConsulta['tar_archivo'];?></a><?php }?>
												</div>
											</div>
