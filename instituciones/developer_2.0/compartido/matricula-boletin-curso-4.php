    ...
    BOLET&Iacute;N DE CALIFICACIONES<br>-->
        ...
        <table width="100%" id="tblBoletin" cellspacing="0" cellpadding="0" rules="all" border="1" align="left">
            ...
            while ($fila = mysql_fetch_array($consulta_mat_area_est)) {
                ...
                $consulta_notdef_area = mysql_query("SELECT (SUM(bol_nota)/COUNT(bol_nota)) as suma,ar_nombre, ar_id FROM academico_materias am
                ...
                $consulta_a_mat = mysql_query("SELECT (SUM(bol_nota)/COUNT(bol_nota)) as suma, ar_nombre, mat_nombre, mat_id, car_id, mat_valor FROM academico_materias am
                ...
                $consulta_a_mat_per = mysql_query("SELECT bol_nota,bol_periodo,ar_nombre,mat_nombre,mat_id, mat_valor FROM academico_materias am
                ...
                if ($numfilas_not_area > 0) {
                    ...
                    $sumaValorMaterias = mysql_fetch_array(mysql_query("SELECT SUM(mat_valor) FROM academico_materias
            ...
            ?>
                ...
                WHERE bol_carga='".$fila2["car_id"]."' AND bol_estudiante='".$matriculadosDatos['mat_id']."' AND bol_periodo='".$_GET['periodo']."'",$conexion));
                        ...
                        $notaFinal = mysql_fetch_array(mysql_query("SELECT ROUND(AVG(bol_nota),2) AS def FROM academico_boletin 
