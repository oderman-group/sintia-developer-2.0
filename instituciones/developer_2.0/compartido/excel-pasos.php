                ...
                <tr>
                    ...
                    <td align="center">
                        ...
                        <?php if ($resultado["mat_pago_matricula"] == 1 and $resultado["mat_soporte_pago"] != "") { ?>
                            <br> <a href="https://plataformasintia.com/instituciones/v2.0/files/comprobantes/<?= $resultado["mat_soporte_pago"]; ?>" target="_blank" style="color:blue;">Soporte</a>
                        <?php } ?>
                    </td>
                    ...
                    <td align="center" bgcolor="<?= $colorFirma; ?>">
                        ...
                        <?php if ($resultado["mat_hoja_firma"] == 1 and $resultado["mat_firma_adjunta"] != "") { ?>
                            <br> <a href="https://plataformasintia.com/instituciones/v2.0/files/comprobantes/<?= $resultado["mat_firma_adjunta"]; ?>" target="_blank" style="color:blue;">Firma</a>
                        <?php } ?>
                    </td>
