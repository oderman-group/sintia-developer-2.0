...
<?php $idPaginaInterna = 'DC0057';?>
<?php include("../compartido/historial-acciones-guardar.php");?>
<?php include("verificar-carga.php");?>
<?php include("../compartido/head.php");?>
<?php
$datosConsultaBD = mysql_fetch_array(mysql_query("SELECT * FROM academico_formatos WHERE form_id='".$_GET["idR"]."'",$conexion));
?>
									...
									<form name="formularioGuardar" action="guardar.php?carga=<?=$cargaConsultaActual;?>&periodo=<?=$periodoConsultaActual;?>" method="post">
										...
										<input type="hidden" value="<?=$_GET["idR"];?>" name="idR">
											...
											<div class="form-group row">
												...
												<div class="col-sm-10">
													<input type="text" name="titulo" value="<?=$datosConsultaBD['form_nombre'];?>" class="form-control" autocomplete="off" required>
												</div>
											</div>
