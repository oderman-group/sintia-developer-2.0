									...
									<form name="formularioGuardar" action="guardar.php?carga=<?=$cargaConsultaActual;?>&periodo=<?=$periodoConsultaActual;?>" method="post">
										...
										<input type="hidden" value="<?=$_GET["idR"];?>" name="idR">
											...
											<div class="form-group row">
												...
												<div class="col-sm-10">
													<input type="text" name="contenido" class="form-control" autocomplete="off" value="<?=$datosConsultaBD['cro_tema'];?>" required>
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-sm-10">
													<input type="text" name="recursos" class="form-control" autocomplete="off" value="<?=$datosConsultaBD['cro_recursos'];?>">
												</div>
											</div>
											...
											<div class="form-group row">
													...
													<div class="col-sm-4">
														<input type="date" name="fecha" class="form-control" autocomplete="off" value="<?=$datosConsultaBD['cro_fecha'];?>" required>
													</div>
											</div>
