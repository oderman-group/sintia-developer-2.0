                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title"><?=$frases[165][$datosUsuarioActual[8]];?> <?=$frases[139][$datosUsuarioActual[8]];?></div>
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active"><?=$frases[165][$datosUsuarioActual[8]];?> <?=$frases[139][$datosUsuarioActual[8]];?></li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
									...
									<form name="formularioGuardar" action="guardar.php?carga=<?=$cargaConsultaActual;?>&periodo=<?=$periodoConsultaActual;?>" method="post">
										...
										<input type="hidden" value="<?=$_GET["idE"];?>" name="idE">
											...
											<div class="form-group row">
												...
												<div class="col-sm-10">
													<input type="text" name="contenido" value="<?=$datosConsultaBD['preg_descripcion'];?>" placeholder="Escriba aquí la pregunta..." class="form-control" autocomplete="off" required>
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="input-group spinner col-sm-10">
													<label class="switchToggle">
														<input type="checkbox" name="critica" value="1" <?php if($datosConsultaBD['preg_critica']==1) echo "checked";?> >
