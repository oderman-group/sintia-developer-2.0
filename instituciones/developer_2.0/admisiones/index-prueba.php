        ...
        <div class="row justify-content-md-center">
            ...
            <div class="col col-lg-12">
                ...
                <div class="jumbotron">
                    ...
                    <h1 class="display-5">Hola, bienvenido a ICOLVEN!</h1>

                    <p class="lead">El costo del formulario es de $50.000</p>
                ...
                <form action="index-guardar.php" method="post">
                    ...
                    <p class="h6 text-info">Recuerde que puede hacer su pago mediante PSE, tarjeta crédito, efectivo o transferencia.</p>


                    <div class="text-right">
                        <button type="submit" class="btn btn-success btn-lg"><i class="fa fa-credit-card" aria-hidden="true"></i> Continuar al pago</button>
                    </div>
